...
mod process {
    ...
    impl ::core::cmp::PartialEq for State {
        #[inline]
        fn eq(&self, other: &State) -> bool { loop  { } }
    }
    ...
    impl ::core::clone::Clone for FaultResponse {
        #[inline]
        fn clone(&self) -> FaultResponse { loop  { } }
    }
    #[allow(unused_qualifications)]
    ...
    impl ::core::cmp::PartialEq for FaultResponse {
        #[inline]
        fn eq(&self, other: &FaultResponse) -> bool { loop  { } }
    }
    ...
    impl ::core::clone::Clone for FunctionCallSource {
        #[inline]
        fn clone(&self) -> FunctionCallSource { loop  { } }
    }
    #[allow(unused_qualifications)]
    ...
    impl ::core::clone::Clone for FunctionCall {
        #[inline]
        fn clone(&self) -> FunctionCall { loop  { } }
    }
    #[allow(unused_qualifications)]
